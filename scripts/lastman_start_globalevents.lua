local TELEPORT_POSITION = Position(32647, 31908, 7) -- posição onde ira criar o teleport
...
local function warnEvent(i, minutes)
	Game.broadcastMessage("[The Last Man Standing] O evento começa em ".. minutes .. " minutes! The portal is located in the event room (you may access it by the temple) O portal .")
	if i > 1 then
